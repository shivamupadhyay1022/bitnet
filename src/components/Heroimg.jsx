...
function Heroimg() {
  return (
    <div className=' m-8 md:m-12 font-oswald flex  flex-col md:flex-row'>
        <div className='' >        
        <div className=' flex flex-col align-middle justify-center items-center md:items-start  h-full gap-4 md:gap-8 ' >
            ...
            <button className='bg-black justify-self-center text-white py-2 px-4 rounded-2xl'  >
                ...discover
            </button>
        </div>
        </div>
